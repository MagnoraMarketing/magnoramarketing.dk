export default {
  ...
  whatIsIt: {
    ...
    paragraph1: 'En AI voice widget er et intelligent taleinterface, der sidder diskret på din hjemmeside – typisk som en flydende knap i hjørnet. Når en besøgende klikker, kan de tale direkte med din AI-assistent.',
    paragraph2: 'AI-assistenten forstår naturligt dansk tale, kan svare på spørgsmål om din virksomhed, og booke møder direkte ind i din kalender – helt uden menneskelig indgriben.',
    paragraph3: 'Det er som at have en receptionist, der aldrig sover, aldrig er syg og altid er professionel – til en brøkdel af prisen.',
    capabilities: [
      'Talebaseret',
      'Tekst-chat',
      'Auto-booking',
    ...
    mockup: {
      ...
      statusListening: 'Lytter…',
      userMessage1: 'Hej, jeg vil gerne booke en tid i næste uge',
      aiMessage1: 'Selvfølgelig! Jeg kan se, der er ledige tider tirsdag kl. 10 og torsdag kl. 14. Hvad passer dig bedst?',
      userMessage2: 'Torsdag klokken 14, tak',
      aiMessage2: 'Perfekt – din tid torsdag kl. 14 er booket! Du modtager en bekræftelse på e-mail om et øjeblik. 📅',
    },
  },
  howItWorks: {
    ...
    steps: [
      { title: 'Installer widgetten', desc: 'Du får en enkel JavaScript-kodestump. Indsæt den på din hjemmeside – kompatibel med WordPress, Shopify, Wix og alle andre platforme. Ingen teknisk viden kræves.' },
      { title: 'Kunder taler med AI', desc: 'Besøgende på din hjemmeside klikker på widgetten og taler direkte med din personlige AI-assistent. AI\'en forstår dansk og svarer på spørgsmål om din virksomhed.' },
      { title: 'Bookinger lander automatisk', desc: 'Møder og bookinger registreres direkte i din kalender. Du modtager en bekræftelse, og kunden får automatisk en kvittering – uden du skal gøre noget.' },
    ],
  ...
  roi: {
    ...
    descriptionHtml: 'En deltidsreceptionist koster typisk 15.000-20.000 kr/md. Med AI voice widgetten til <strong class="text-white">999 kr/md</strong> får du samme funktionalitet – men 24 timer i døgnet, 7 dage om ugen.',
    stats: [
