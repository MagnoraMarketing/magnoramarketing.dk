export default {
  ...
  buildProject: {
    ...
    pricingTitle: 'Hvad koster det – og hvad får du?',
    pricingItems: [
    ...
    ctaNote: 'Klar til at komme i gang?',
    ctaButton: 'Få et fast tilbud',
  },
  benefits: {
  ...
  aiTools: {
    ...
    subtitle: 'Magnora Marketing arbejder med de bedste danske AI-platforme og integrerer dem sømlöst i jeres eksisterende forretningsprocesser.',
    featuresLabel: 'Hvad integrationen giver dig:',
    exampleLabel: 'Eksempel fra praksis',
    ctaLabel: 'Integrer {{name}} i din virksomhed',
    tools: [
      {
  ...
  workflows: {
    ...
    ctaLabel: 'Få dette workflow implementeret',
    items: [
      {
  ...
  useCases: {
    ...
    ctaLabel: 'Book en AI-konsultation',
  },
  whyUs: {
