export default {
  ...
  intro: {
    heading: 'Hvad er remote salg hos Magnora Marketing?',
  ...
  chooseProduct: {
    heading: 'Vælg det produkt du brænder for',
  ...
  gettingStarted: {
    ...
    paragraph1: 'Kig på vores ledige stillinger, find det produkt der passer dig, og send os en kort besked. Ingen formel ansøgning – bare skriv til os.',
    paragraph2: 'Vi vender tilbage inden for 2 hverdage og sætter et afklaringsmøde op.',
    primaryCta: 'Se alle ledige stillinger',
    secondaryCta: 'Kontakt Magnora Marketing direkte',
  },
  longSection1: {
    heading: 'Freelance Remote Salg – Arbejd Hjemmefra som B2B Sælger hos Magnora Marketing',
    paragraph1: "Remote salg er fremtiden for B2B telemarketing og mødebooking – og hos Magnora Marketing er det hverdagen. Som remote freelance sælger arbejder du 100% hjemmefra med moderne digitale salgsværktøjer, klare processer og stærk støtte fra Magnora Marketing's erfarne salgsledere. Du behøver ingen dyr pendling, intet kontor og ingen faste mødetider – bare et stabilt internet, en telefon og drivkraften til at skabe resultater. Magnora Marketing leverer alt det andet: leads, scripts, CRM-adgang og løbende sparring.",
    paragraph2: 'Remote salgsstillinger hos Magnora Marketing dækker et bredt spektrum af brancher og produkter – fra webudvikling og digitale løsninger til solenergi, LED-belysning, kaffeservice, pensionsrådgivning og B2B mødebooking. Du vælger selv det produkt og den branche der matcher din baggrund og interesse, og Magnora Marketing matcher dig med den kampagne der passer bedst til dine kompetencer og ambitioner.',
    bullets: [
  ...
  longSection2: {
    heading: 'Freelance Hjemmekontor – Kom i Gang med Remote Salg hos Magnora Marketing',
    paragraph1: 'At starte som remote freelance sælger hos Magnora Marketing er enkelt og hurtigt. Du finder et produkt der passer til dig, sender os en besked – ingen formel ansøgning nødvendig – og Magnora Marketing vender tilbage inden for 2 hverdage. Derefter gennemgår du et kort onboarding-forløb med produkttræning og salgsteknik, og er klar til at starte inden for få dage. De fleste sælgere finder deres rytme og leverer solide resultater inden for de første 4-6 uger.',
    paragraph2: 'Kontakt Magnora Marketing på mail@magnoramarketing.dk og hør mere om de aktuelle remote salgsmuligheder. Vi er klar til en uforpligtende snak om hvad Magnora Marketing kan tilbyde dig.',
  },
  faqs: [
