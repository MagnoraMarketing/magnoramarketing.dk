export default {
  ...
  process: {
    ...
    steps: [
      { title: 'Opstartsmøde', description: 'Vi starter med et grundigt møde for at forstå din virksomhed, dine produkter og din ideelle kunde.' },
      { title: 'Strategi & Opsætning', description: "Vi udvikler en skræddersyet strategi med klare KPI'er, målsætninger og kommunikationsplaner." },
      { title: 'Kampagnestart', description: 'Vores team briefes grundigt og går i gang med telemarketing eller mødebooking med løbende feedback og justering.' },
      { title: 'Opfølgning & Optimering', description: 'Vi evaluerer resultater løbende og optimerer indsatsen kontinuerligt for at sikre den bedste ROI for dig.' },
    ],
  },
  contactSection: {
