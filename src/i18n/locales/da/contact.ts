export default {
  ...
  hero: {
    ...
    subtitle: 'Vi er klar til at hjælpe dig med dine spørgsmål om telemarketing, mødebooking eller jobmuligheder. Udfyld formularen nedenfor, eller kontakt os direkte.',
  },
  form: {
    title: 'Send os en besked',
    subtitle: 'Vælg hvad din henvendelse drejer sig om, så lander den hos den rette specialist med det samme.',
    sourceLabel: 'Kontaktsiden',
  },
  info: {
    title: 'Kontaktoplysninger',
    companyName: 'Magnora Marketing',
    addressHtml: 'Calle Purisima 5<br />46540 El Puig<br />Valencia, Spanien',
    emailLabel: 'Email',
    websiteLabel: 'Website',
  },
  hours: {
    title: 'Åbningstider',
    monThuLabel: 'Mandag - Torsdag:',
    monThuValue: '8:00 - 16:00',
    friLabel: 'Fredag:',
    friValue: '8:00 - 15:00',
    weekendLabel: 'Lørdag - Søndag:',
    weekendValue: 'Lukket',
  },
  seoContent: {
    title: 'Professionel Mødebooking & Telemarketing Partner',
    p1: 'Magnora Marketing er din professionelle partner inden for B2B telemarketing og mødebooking. Med over 20 års erfaring i branchen har vi specialiseret os i at skabe værdifulde forbindelser mellem virksomheder og hjælpe vores kunder med at vækste gennem målrettede salgsaktiviteter.',
    p2: 'Vores dedikerede team af erfarne telemarketingkonsulenter og mødebookere arbejder målrettet med at generere kvalificerede leads og booke møder med beslutningstagere i jeres målgruppe. Vi tilbyder skræddersyede løsninger tilpasset jeres specifikke behov og branche.',
    listIntro: 'Som samarbejdspartner får I adgang til:',
    list: [
      'Professionel telemarketing og leadgenerering',
      'Kvalificeret mødebooking med beslutningstagere',
      'Erfarne konsulenter med branchekendskab',
      'Detaljeret rapportering og opfølgning',
      'Fleksible samarbejdsmodeller',
    ],
    p3: 'Kontakt os i dag for en uforpligtende snak om, hvordan vi kan hjælpe jeres virksomhed med at nå jeres salgsmål gennem professionel telemarketing og mødebooking.',
  },
  info1: {
    title: 'Kontakt Magnora Marketing – Din Vækstpartner inden for Telesalg, Mødebooking og AI',
