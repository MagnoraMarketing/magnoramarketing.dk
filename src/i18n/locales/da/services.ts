export default {
  ...
  digitalSection: {
    badge: 'Digital, AI & webudvikling',
    title: 'Vi er skarpe på AI, unik webudvikling – og salget der følger med',
    subtitle: 'Fra intelligente AI-løsninger til flotte, professionelle hjemmesider og komplekse platforme. Og når løsningen er klar, kan vi endda hjælpe med at booke møder og sælge den – for vi kender allerede kunden og projektet. Det er en rigtig god start.',
    items: [
      {
        title: 'AI-integration & udvikling',
        description: 'Vi er skarpe på at bygge og integrere AI – fra chatbots og automatisering til skræddersyet AI-udvikling, der giver din forretning et forspring.',
      },
      {
        title: 'Flotte hjemmesider til en god pris',
        description: 'Professionelle, unikke og konverteringsstærke hjemmesider, der repræsenterer din virksomhed flot – uden at sprænge budgettet.',
      },
      {
        title: 'Kompleks webudvikling',
        description: 'Avancerede webapplikationer, kundeportaler og SaaS-platforme bygget fra bunden med moderne teknologi og bygget til at skalere.',
      },
      {
        title: 'Hjælp til møder & salg',
        description: 'Vi kan endda booke møder og sælge den nye løsning for dig – og fordi vi kender kunden og projektet, er vi på forkant fra dag ét.',
      },
    ],
    ctaPrimary: 'Se webudvikling & AI',
    ctaSecondary: 'Fortæl os om dit projekt',
  },
  coreServices: {
  ...
  ctaBanner: {
    ...
    buttonText: 'Få et gratis tilbud',
  },
  info1: {
