export default {
  ...
  differentiators: {
    heading: 'Hvad gør en Magnora Marketing-hjemmeside anderledes?',
  ...
  siteTypesSection: {
    heading: 'Hjemmesidetyper vi specialiserer os i',
  ...
  budget: {
    label: 'Prisvenlige hjemmesider',
    heading: 'Færdige branche-designs – fra kun 1.500 kr',
    ...
    badgePrice: '<span class="font-semibold text-gray-900">Fra kun 1.500 kr</span> pr. hjemmeside',
    badgeImages: '<span class="font-semibold text-gray-900">Tilpas med egne billeder</span> og tekst',
    badgeFast: '<span class="font-semibold text-gray-900">Hurtigt online</span> – klar på få dage',
    priceTag: 'Fra 1.500 kr',
    items: [
    ...
    imageAltTemplate: 'Prisvenligt hjemmeside-design til branchen {{branche}}',
    customizeNote: 'Tilpas med dine egne billeder',
    noIndustry: 'Kan du ikke se din branche? Vi laver et prisvenligt design til enhver branche.',
    cta: 'Bestil din hjemmeside fra 1.500 kr',
  },
  showcase: {
    label: 'Referencer',
    heading: 'Hjemmesider vi har bygget',
    subtitle: 'Se et udvalg af live hjemmesider vi har lavet. Klik på et kort for at besøge den rigtige side.',
    visitLabel: 'Besøg side',
    altTemplate: 'Hjemmeside vi har bygget: {{name}}',
    items: [
  ...
  midCta: {
    heading: 'Klar til en ny hjemmeside?',
  ...
  article1: {
    heading: 'Professionelle Hjemmesider der Konverterer – SEO-Optimeret og Mobilvenlig Design',
    p1: 'En professionel hjemmeside fra Magnora Marketing er din vigtigste digitale investering – den arbejder for dig 24 timer i døgnet, 7 dage om ugen, og er ofte det første møde potentielle kunder har med din virksomhed. Magnora Marketing designer og bygger hjemmesider med et klart formål: at konvertere besøgende til leads og kunder. Vi kombinerer professionelt visuelt design, stærk UX-planlægning og teknisk SEO-optimering for at sikre at din hjemmeside both ser flot ud og ranker godt i Google.',
  ...
  article2: {
    heading: 'Hjemmeside Priser og Typer – Fra Enkle Landingssider til Komplette Webshops',
