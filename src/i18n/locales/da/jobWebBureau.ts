export default {
  ...
  about: {
    ...
    paragraph1: 'Som freelance sælger for web bureau ydelser hos Magnora Marketing kontakter du danske virksomheder og præsenterer vores webudvikling, landingssider, SEO og digitale løsninger. Du arbejder selvstændigt hjemmefra – Magnora Marketing sørger for scripts, materialer og løbende support.',
    paragraph2: 'Du behøver ikke teknisk baggrund – du skal forstå forretning og have lyst til at hjælpe virksomheder med at vokse online. Vi oplærer dig i produkterne og salgsprocessen.',
    tasks: [
  ...
  products: {
    heading: "Det sælger du – Magnora Marketing's digitale ydelser",
  ...
  howToApply: {
    ...
    paragraph1: 'Send os en kort besked om hvem du er, hvad du har prøvet, og hvorfor du vil sælge digitale løsninger. Vi vender tilbage inden for 2 hverdage.',
    paragraph2: 'Ingen formel ansøgning nødvendig – bare skriv til os. Vi vurderer alle henvendelser individuelt.',
  ...
  finalCta: {
    heading: 'Klar til at sælge digitale løsninger?',
