export default {
  ...
  offerings: {
    heading: 'Hvad Magnora Marketing tilbyder inden for API & SaaS',
  ...
  integrations: {
    heading: 'Integrationer vi arbejder med',
  ...
  scalable: {
    heading: 'Skalerbare løsninger der vokser med dig',
  ...
  midCta: {
    heading: 'Har du et API- eller SaaS-projekt?',
  ...
  article1: {
    heading: 'API-Udvikling og SaaS-Platforme – Skalerbare Digitale Løsninger fra Magnora Marketing',
  ...
  article2: {
    heading: 'Systemintegration og API-Forbindelser der Automatiserer din Forretning',
