      ...
      <section id="ansog" className="py-20 bg-white scroll-mt-24">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Send din ansøgning – Måtteservice</h2>
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-3xl p-6 md:p-10 shadow-sm">
            <ContactForm presetTopic="Job henvendelse" sourceLabel="Jobside: Måtteservice" />
          </div>
        </div>
      </section>
